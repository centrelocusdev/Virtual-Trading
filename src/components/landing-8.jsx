...
const Landing_8 = () => {
  return (
    <div className='w-full h-h-99 py-14 px-24 bg-gradient-to-r from-bg_Medium to-blue7 flex items-center justify-center'>
      ...
      <div className='w-full h-full flex gap-x-40'>
        <img className='w-1/2 h-full' src={feedback} alt='about-us'/>
        <div className='text-center w-1/2 rounded-5xl bg-white p-12 text-base font-poppins text-black font-medium flex items-center'>
