...
const Landing_4 = () => {
  return (
    <div className='w-full esm:h-fit md:h-h-99 bg-green6 py-12 esm:px-5 md:px-32 flex justify-center items-center'>
        <div className='w-full h-full flex flex-col  m-auto justify-center items-center pt-10'>
            ...
            <div className='w-full flex items-center esm:mt-10  esm:flex-col md:flex-row gap-10 m-auto justify-center'>
                <div className='flex flex-col  w-60 items-center'>
                    ...
                    <p className='text-3xl font-semibold font-sora mb-5 text-center'>Register</p>
                    <p className='text-base font-poppins text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
                ...
                <div className='flex mb-5  justify-center items-center w-12 h-12 rounded-full border-2 border-solid border-purple1'>2</div>
                    ...
                    <p className='text-3xl font-semibold font-sora mb-5 text-center'>Buy & Sell</p>
                    <p className='text-base font-poppins text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
                <div className='mt-5 w-40 border-t-2 border-t-purple1'></div>
                <div className='flex flex-col w-60 items-center'>
                <div className='flex mb-5  justify-center items-center w-12 h-12 rounded-full border-2 border-solid border-purple1'>3</div>
                    ...
                    <p className='text-3xl font-semibold font-sora mb-5 text-center'>Earn</p>
                    <p className='text-base font-poppins text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
            </div>
        </div>
