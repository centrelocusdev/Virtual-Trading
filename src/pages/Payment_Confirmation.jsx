  ...
  return (
    <div className="min-h-screen  h-fit w-screen flex justify-center items-center p-20 bg-bg_Light">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="p-9 mb-0">
        <img className="esm:h-28 esm:w-28 md:h-28 md:w-28 xl:h-56 xl:w-56" src={check} alt="check" />
        </div>
        ...
        <button onClick={() => {navigate('/kyc')}} className="px-11 py-4.1 esm:text-sm sm:text-lg bg-font_blue1 text-white rounded-md self-center">Click To Complete KYC</button>
      </div>
    </div>
  );
};
